...
import com.dsbath.admin.etc.security.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// 로그인 설정	
		http.formLogin()
			.loginPage("/" + Constant.NOTILES + "/" + Constant.LOGIN_PAGE)
		...
		// 로그아웃 설정
			...
			.permitAll()
			.logoutSuccessUrl("/" + Constant.NOTILES + "/" + Constant.LOGIN_PAGE)
